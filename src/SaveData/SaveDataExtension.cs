namespace SlugBase.SaveData
{
    ...
    public static class SaveDataExtension
    {
        ...
        public static SlugBaseSaveData GetSlugBaseData(this DeathPersistentSaveData data) => new(data);
        ...
        public static SlugBaseSaveData GetSlugBaseData(this MiscWorldSaveData data) => new(data);
        ...
        public static SlugBaseSaveData GetSlugBaseData(this PlayerProgression.MiscProgressionData data) => new(data);
    }
}